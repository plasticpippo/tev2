...
const ProductGridPreview: React.FC<ProductGridPreviewProps> = ({
  gridItems,
  setGridItems,
  handleMoveItem,
}) => {
  return (
    <div className="bg-slate-700 p-4 rounded-lg">
      ...
      <div
        className="relative bg-slate-900 rounded-lg p-4 min-h-[500px] border-2 border-dashed border-slate-50"
        ...
        onDrop={(e) => {
          ...
          setGridItems((prevItems: GridItem[]) =>
            prevItems.map((item: GridItem) =>
