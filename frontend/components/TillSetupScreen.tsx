...
className="p-6 min-h-16 bg-slate-700 rounded-lg text-white font-bold text-xl hover:bg-amber-600 transition focus:outline-none focus:ring-2 focus:ring-amber-500"
>
{till.name}
</button>
            ))}
