...
interface LayoutSettingsPanelProps {
  ...
  categories: any[]; // Using any for now to match the original implementation
  ...
  return (
    <div className="bg-slate-700 p-4 rounded-lg">
      ...
      <div className="flex flex-col gap-2">
        ...
        <button
          onClick={onCancel}
          className="bg-slate-600 hover:bg-slate-700 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-slate-400 transition"
        >
          Cancel
        </button>
      </div>
      <button
        ...
        className="w-full mt-2 bg-red-700 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-red-500 transition"
      >
        Clear Grid
      </button>
    </div>
